...
function processSemesterData(data) {
    ...
    for (let i = 0; i < data.length; i++) {
        ...
        if (item.id === 167) {
            a.text("2020/2021 Ganjil - Magister Sains Biomedis");
        } else if (item.id === 329) {
            a.text("2021/2022 Ganjil - Magister Sains Biomedis");
        } else if (item.id === 453) {
            a.text("2022/2023 Ganjil - Magister Sains Biomedis");
        } else if (item.id === 537) {
            a.text("2022/2023 Genap - Magister Sains Biomedis");
        }
