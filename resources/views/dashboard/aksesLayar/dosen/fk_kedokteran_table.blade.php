...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Kedokteran Program Pascasarjana</li>
    </ol>
                        ...
                        <table id="table-data" class="table bg-white table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text">299</td>
                                </tr>
                                <tr>
                                    <th scope="row" class="text">Total</th>
                                    <td class="text">2.276</td>
                                </tr>
                            </tbody>
                        </table>
                    </div> <!--col-->
