...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Pendidikan Profesi Kedokteran Gigi</li>
    </ol>
        ...
        <div class="col mx-2 bg-white rounded card content" id="wrapper-content">
            ...
            <div class="row g-0 my-3">
                <div class="row mb-4">
                    ...
                    <span class="fs-6 mb-3 text">Pendidikan Profesi Kedokteran Gigi</span>
    ...
    <script src="{{ asset('js/semester/fkg/profesi/profesi.js') }}"></script>
@endsection
