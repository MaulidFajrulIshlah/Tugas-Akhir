...
<div class="w-100 d-flex position-relative" style="left: 10px; ">
            @can('admin')
                <div class="row my-1 w-100" id="loading">
                    <div class="content col w-100 p-3 rounded card" style="background-color: #F5EFE6; border: 2px solid var(--secondary)">
                        <h5 class="mb-3 text text-center fw-bold title" style="color: var(--primary-green);"> Daftar Pengguna Dengan Status Suspend</h5>
                        <table id="data-suspend" class="table table-bordered table-hover cell-border" style="color: var(--primary-green);">
                            <thead class="table-success">
                                <tr class="text">
                                    <th scope="col" class="text" width="50">No</th>
                                    <th scope="col" class="text">Nama Pengguna</th>
        ...
        <div class="right-container-sort">
            ...
            <form id="hitung-form" action="{{ route('beranda') }}">
                <select name="kategori" id="kategori" onchange="submitForm()">
                    ...
                    <option value="16">TI</option>
                    <option value="40">Perpus</option>
                    <option value="37">PSI</option>
                    <option value="588">KEDOKTERAN</option>
                    <option value="180">KEDOKTERAN GIGI</option>
                    <option value="34">HUKUM</option>
                    <option value="187">MANAJEMEN</option>
                    <option value="130">AKUNTASI</option>
                </select>
        </div>
    </div>
</div>
...
@if (isset($totalQuiz))
<script>
    var totalQuiz = json_encode($totalQuiz);
    document.addEventListener("DOMContentLoaded", function() {
        ...
        dropdown.addEventListener("change", function() {
            ...
            if (selectedValue === "akuntansi") {
                ...
                totalElement.textContent = totalQuiz;
