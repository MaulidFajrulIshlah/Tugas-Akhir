...
@section('card')
    ...
    <script src="{{ asset('js/daftarMatkul/dekanat_tendik_prodi/dekanat_tendik_fk.js') }}"></script>
    @endcan

    @can('dekanat-tendik-fkg')
    <!-- Daftar Matkul Card -->
    <div class="col-xl-4 col-md-6 col-11 col-lg-5">
        <div class="card">
            <div class="card-body">
    ...
    <script src="{{ asset('js/daftarMatkul/dekanat_tendik_prodi/dekanat_tendik_fkg.js') }}"></script>
    @endcan
