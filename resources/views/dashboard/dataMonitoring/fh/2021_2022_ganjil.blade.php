...
>>>>>>> Stashed changes
    ...
    <script src="{{ asset('js/dataMonitoring/fh/2021_2022_ganjil.js') }}"></script>
            ...
            $.ajax({
                ...
                success: function (data, status, xhr) {
                    for (let i = 0; i < data.length; i++) {
                        if (data[i]['categoryid'] == 271 || data[i]['categoryid'] == 272 ||  data[i]['categoryid'] == 273 || data[i]['categoryid'] == 274 ||  data[i]['categoryid'] == 275) {
