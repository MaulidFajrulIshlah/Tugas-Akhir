        ...
        <div class="col mx-2 bg-white rounded card content" id="wrapper-content">
            <div class="row g-0 my-3">
                <div class="row mb-4">
                    ...
                    <span class="fs-6 mb-3 text">Semester 2020/2021 Genap - Hukum</span>
                    {{-- Table --}}
...
>>>>>>> Stashed changes
    ...
    <script src="{{ asset('js/dataMonitoring/fh/2020_2021_genap.js') }}"></script>
            ...
            $.ajax({
                ...
                success: function (data, status, xhr) {
                    for (let i = 0; i < data.length; i++) {
                        if (data[i]['categoryid'] == 181 || data[i]['categoryid'] == 182 ||  data[i]['categoryid'] == 183 || data[i]['categoryid'] == 184) {
