        ...
        <div class="col mx-2 bg-white rounded card content" id="wrapper-content">
            <div class="row g-0 my-3">
                <div class="row mb-4">
                    ...
                    <span class="fs-6 mb-3 text">Semester 2021/2022 Genap - Hukum</span>
                    {{-- Table --}}
...
>>>>>>> Stashed changes
    ...
    <script src="{{ asset('js/dataMonitoring/fh/2021_2022_genap.js') }}"></script>
            ...
            $.ajax({
                ...
                success: function (data, status, xhr) {
                    for (let i = 0; i < data.length; i++) {
                        if (data[i]['categoryid'] == 350 || data[i]['categoryid'] == 351 ||  data[i]['categoryid'] == 352) {
