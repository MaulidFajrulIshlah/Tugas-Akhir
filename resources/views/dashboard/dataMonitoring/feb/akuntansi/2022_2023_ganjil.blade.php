...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">2022_20223 Ganjil</li>
    </ol>
...
>>>>>>> Stashed changes
    ...
    <script src="{{ asset('js/dataMonitoring/feb/akuntansi/2022_2023_ganjil.js') }}"></script>
            ...
            $.ajax({
                ...
                success: function (data, status, xhr) {
                    for (let i = 0; i < data.length; i++) {
                        if (data[i]['categoryid'] == 449 || data[i]['categoryid'] == 450 || data[i]['categoryid'] == 451 || data[i]['categoryid'] == 452) {
