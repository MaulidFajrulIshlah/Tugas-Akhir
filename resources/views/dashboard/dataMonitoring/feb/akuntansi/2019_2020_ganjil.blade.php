        ...
        <div class="col mx-2 bg-white rounded card content" id="wrapper-content">
            <div class="row g-0 my-3">
                <div class="row mb-4">
                    ...
                    <span class="fs-6 mb-3 text">Semester 2019/2020 Ganjil - Akuntansi</span>
                    {{-- Table --}}
...
>>>>>>> Stashed changes
    ...
    <script src="{{ asset('js/dataMonitoring/feb/akuntansi/2019_2020_ganjil.js') }}"></script>
