                ...
                <ul class="semester">
                    @foreach ($prodi as $prodis)
                        @if($prodis->id == 13)
                            ...
                            <li class="link">
                                <a href="{{ route('akademik', ['unitID' => $prodis->id, 'categoryID' => '67']) }}" class="text fs-5 text-center"><i class="fas fa-caret-right m-3"></i>2019/2020 Antara</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="{{ route('akademik', ['unitID' => $prodis->id, 'categoryID' => '420']) }}" class="text fs-5 text-center"><i class="fas fa-caret-right m-3"></i>2021/2022 Antara</a>
                            </li>
                            <li class="link">
