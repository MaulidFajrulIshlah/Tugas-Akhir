        ...
        <div class="col mx-2 bg-white rounded card content" id="wrapper-content">
            <div class="row g-0 my-3">
                <div class="row mb-4">
                    ...
                    <span class="fs-6 mb-3 text">Semester 2021/2022 Ganjil - Akuntansi</span>
<<<<<<< Updated upstream
                    {{-- Table --}}
...
>>>>>>> Stashed changes
    ...
    <script src="{{ asset('js/dataMonitoring/feb/akuntansi/2021_2022_ganjil.js') }}"></script>
            ...
            $.ajax({
                ...
                success: function (data, status, xhr) {
                    for (let i = 0; i < data.length; i++) {
                        if (data[i]['categoryid'] == 280 || data[i]['categoryid'] == 281 || data[i]['categoryid'] == 282) {
                              // || data[i]['categoryid'] == 327 => kode kurikulum 2018 & 2012 semester 7
