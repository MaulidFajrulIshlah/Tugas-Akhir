        ...
        <div class="col mx-2 bg-white rounded card content" id="wrapper-content">
            <div class="row g-0 my-3">
                <div class="row mb-4">
                    ...
                    <span class="fs-6 mb-3 text">Semester 2019/2020 Genap - Manajemen</span>
                    {{-- Table --}}
...
>>>>>>> Stashed changes
    ...
    <script src="{{ asset('js/dataMonitoring/feb/manajemen/2019_2020_genap.js') }}"></script>

<<<<<<< Updated upstream
=======
                success: function (data, status, xhr) {
                    for (let i = 0; i < data.length; i++) {
                        if (data[i]['categoryid'] == 32) {
