...
>>>>>>> Stashed changes
    ...
    <script src="{{ asset('js/dataMonitoring/feb/manajemen/2020_2021_ganjil.js') }}"></script>

<<<<<<< Updated upstream
=======
                success: function (data, status, xhr) {
                    for (let i = 0; i < data.length; i++) {
                        if (data[i]['categoryid'] == 160 || data[i]['categoryid'] == 161 || data[i]['categoryid'] == 162 || data[i]['categoryid'] == 163) {
