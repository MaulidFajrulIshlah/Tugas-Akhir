        ...
        <div class="col mx-2 bg-white rounded card content" id="wrapper-content">
            <div class="row g-0 my-3">
                <div class="row mb-4">
                    ...
                    <span class="fs-6 mb-3 text">Semester 2022/2023 Genap - Ilmu Perpustakaan</span>
                    {{-- Table --}}
...
>>>>>>> Stashed changes
    ...
    <script src="{{ asset('js/dataMonitoring/fti/ip/2022_2023_genap.js') }}"></script>
