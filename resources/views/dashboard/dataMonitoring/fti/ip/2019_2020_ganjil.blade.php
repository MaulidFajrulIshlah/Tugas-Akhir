...
@section('content')
        ...
        <div class="col mx-2 bg-white rounded card content" id="wrapper-content">
            <div class="row g-0 my-3">
                <div class="row mb-4">
                    ...
                    <span class="fs-6 mb-3 text">Semester 2019/2020 Ganjil - Perpustakaan dan Sains Informasi</span>
                    {{-- Table --}}
    ...
    <script src="{{ asset('js/dataMonitoring/fti/ip/2019_2020_ganjil.js') }}"></script>
