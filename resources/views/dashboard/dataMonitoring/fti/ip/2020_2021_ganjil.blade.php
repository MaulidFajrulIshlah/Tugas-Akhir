        ...
        <div class="col mx-2 bg-white rounded card content" id="wrapper-content">
            <div class="row g-0 my-3">
                <div class="row mb-4">
                    ...
                    <span class="fs-6 mb-3 text">Semester 2020/2021 Ganjil - Ilmu Perpustakaan</span>
                    {{-- Table --}}
                    <div class="container mt-3">
                        <table class="table table-master table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="text">2</td>
                                    <td class="text">Keamanan Informasi</td>
                                ...
                                <tr>
                                    <td class="text">8</td>
                                    <td class="text">Teknologi Multimedia</td>
                                ...
                                <tr>
                                    <td class="text">14</td>
                                    <td class="text">Sistem Informasi Manajemen</td>
                                    <td class="text">35 Kegiatan</td>
                                    <td class="text">10 Kegiatan</td>
                                </tr>
                            </tbody>
