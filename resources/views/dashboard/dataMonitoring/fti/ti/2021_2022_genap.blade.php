        ...
        <div class="col mx-2 bg-white rounded card content" id="wrapper-content">
            <div class="row g-0 my-3">
                <div class="row mb-4">
                    ...
                    <span class="fs-6 mb-3 text">Semester 2021/2022 Genap - Teknik Informatika</span>
                    {{-- Table --}}
...
<<<<<<< Updated upstream
    <script src="{{ asset('js/dataMonitoring/fti/ti/2021_2022_genap.js') }}"></script>
