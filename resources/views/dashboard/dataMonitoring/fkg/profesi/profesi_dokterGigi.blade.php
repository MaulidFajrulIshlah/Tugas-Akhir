...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Kedokteran Gigi Program Profesi</li>
    </ol>
    ...
    <div class="row g-3 my-3">
        <div class="col mx-2 bg-white rounded card content" id="wrapper-content">
            ...
            <div class="row g-0 my-3">
                <div class="row mb-4">
                    <h5 class="mb-2 fw-bold text">Akademik</h5>
                    <span class="fs-6 mb-3 text">Kedokteran Gigi Program Profesi</span>
                    {{-- Table --}}
