...
@section('content')
        ...
        <div class="col mx-2 bg-white rounded card content" id="wrapper-content">
            ...
            <div class="row g-0 my-3">
                <div class="row mb-4">
                    ...
                    <span class="fs-6 mb-3 text">Semester 2022/2023 Genap - Kedokteran Gigi</span>
                    {{-- Table --}}
    ...
    <script src="{{ asset('js/dataMonitoring/fkg/kedokteranGigi/kurikulum2018/2022_2023_genap.js') }}"></script>
